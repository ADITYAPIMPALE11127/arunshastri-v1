      ...
      <main className="flex-grow py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-3xl font-bold mb-8 text-center">About Astro Arun Shastri</h1>
...
/>
              ...
              <div className="md:w-2/3">
                <p className="text-lg mb-4">
                  Astro Arun Shastri is a renowned astrologer with over 8 years of experience in Vedic astrology, numerology, and remedial measures. His passion for astrology began at a young age, inspired by his grandfather who was a respected village astrologer.
                </p>
                <p className="text-lg mb-4">
            ...
            <div className="bg-indigo-900 text-white p-8 rounded-lg mb-12">
              ...
              <p className="text-lg mb-4">
                At ArunShastri, our mission is to make the ancient wisdom of Vedic astrology accessible and practical for modern life challenges. We believe that understanding your cosmic blueprint can empower you to make better decisions and live a more fulfilling life.
              </p>
              <p className="text-lg">
