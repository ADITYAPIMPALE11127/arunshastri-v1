        ...
        <section className="bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-800 text-white py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-indigo-200 mb-10 max-w-2xl mx-auto">
              Created by award-winning astrologer Astro Arun Pandit to help you understand your true path.
            </p>
            <Link
              to="/order"
...
/>
              ...
              <div className="md:w-1/2">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-3xl font-bold">About Astro Arun shastri</h2>
                </div>
