  ...
  return (
    <footer className="bg-indigo-900 text-white py-8 sm:py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="text-base sm:text-lg font-semibold mb-4 flex items-center">
              <Award className="h-4 w-4 sm:h-5 sm:w-5 mr-2 text-yellow-300" />
              About Astro Arun Shashtri
            </h3>
            <ul className="space-y-2 text-sm sm:text-base text-indigo-200">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm sm:text-base text-indigo-200">
              <li>
                <Link to="https://merchant.razorpay.com/policy/QXGeS7a6Ubr13P/terms" className="text-yellow-300 hover:underline">
                  Terms and Conditions
                </Link>
                <p className="text-xs sm:text-sm mt-1">Last updated on May 20, 2025</p>
              </li>
              <li>
                <Link to="https://razorpay.com/privacy/" className="text-yellow-300 hover:underline">
                  Privacy Policy
                </Link>
              ...
              <li>
                <Link to="https://merchant.razorpay.com/policy/QXGeS7a6Ubr13P/shipping" className="text-yellow-300 hover:underline">
                  Shipping Policy
                </Link>
                <p className="text-xs sm:text-sm mt-1">Shipping is not applicable for our business. PDF reports only.</p>
              </li>
              <li>
                <Link to="https://merchant.razorpay.com/policy/QXGeS7a6Ubr13P/refund" className="text-yellow-300 hover:underline">
                  Cancellation and Refund
                </Link>
                <p className="text-xs sm:text-sm mt-1">No cancellations & refunds are entertained</p>
              </li>
              <li>
                <Link to="/contact" className="text-yellow-300 hover:underline">Contact Us</Link>
        ...
        <div className="border-t border-indigo-800 mt-8 pt-8 text-center text-xs sm:text-sm text-indigo-300">
